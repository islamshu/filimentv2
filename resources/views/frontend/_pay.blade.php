            ...
            <div class="row">
                        ...
                        <div class="row px-3 justify-content-center justify-content-lg-start">
                            ...
                            <div
                                ...
                                <label class="form-check-label text-center" for="mastercard">
                                    <img src="{{ asset('front/assets/image/icons/mastercard.png') }}" width="65"
                                        height="35" class="mx-1" alt="">
                                </label>
                            </div>
                    @endif
                    ...
                    <div class="row">
                        ...
                        @if ($payment_method == 'installment')
                            <div class="col-lg-12">
                                ...
                                <input type="text" name="first_batch" id="first_batch" readonly
                                    class="form-control rounded mb-3" value="{{ $first_payment }}" autocomplete="off"
                                    required placeholder="الدفعة الأولى">
                            </div>

                            <div class="col-lg-12">
                                <span class="mb-1 d-inline-block spanlable">قيمة كل قسط</span>
                                <input type="text" id="all_batch" readonly class="form-control rounded mb-3"
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" required class="form-control mb-3" name="card_name" id="name"
                                autocomplete="off" placeholder="الأسم على البطاقة" pattern="[A-Za-z\u0600-\u06FF\s]+"
                                title="يجب إدخال اسم صحيح">
                        </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" name="card_number" class="form-control" maxlength="16"
                                pattern="\d{16}" title="يجب أن يكون الرقم 16 رقمًا" required inputmode="numeric"
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            ...
                            <input required type="text" class="form-control" maxlength="3" name="cvc"
                                id="cvc" placeholder="رمز التحقق (cvc)" inputmode="numeric" pattern="\d{3}"
                ...
                <div class="mt-4">
                    <button type="submit" name="confirm" id="CardBtn"
                        style="background: {{ get_general_value('primary_color') }};color:white" class="btn w-100">
